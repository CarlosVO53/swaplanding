...
<div class="container-principal" id="segundo-div">
        ...
        <p class="content-text"><span class="swap-mark">Swap padel</span> es una competición que ha llegado para
            ...
            <p class="content-text"><span class="swap-mark">Todas nuestras competiciones <b>incluyen</b>:</span></p>
                <ul>
                    ...
                    <li class="cnt-li"><span class="cnt-li-text">Detalle de bienvenida</span></li>
                </ul>
    </div>
    ...
    <div class="content-grup cnt-gr-right">
        ...
        <div class="cnt-card-group">
            <div class="cnt-card">
                ...
                <div class="card-text">JUGADORES<br>X<br>DIVISIÓN</div>
            </div>
            <div class="cnt-card">
                <div class="card-number">1</div>
                <div class="card-text">PARTIDO<br>CON<br>CADA JUGADOR</div>
            </div>
            <div class="cnt-card">
                <div class="card-number">2</div>
                <div class="card-text">VECES CONTRA<br>TODOS<br> LOS RIVALES</div>
            </div>
            <div class="cnt-card">
                <div class="card-number">2</div>
    ...
    <div class="content-grup cnt-gr-left">
        ...
        <ul>
            <li class="cnt-li">
                ...
                <p>Cada jornada jugarás de compañero con un participante de la división y os enfrentaréis a una pareja
                    de jugadores de vuestra divisón, al finalizar la temporada habrás jugado con todos los jugadores una
            ...
            <li class="cnt-li">
                ...
                <p>Las temporadas de 3 meses hacen que las divisiones esten equilibradas constantemente para garantizar
                    la máxima competitividad, cada temporada ascenderá y descenderá un jugador de manera directa y otro
                    mediante play-off.</p>
            </li>
            <li class="cnt-li">
                <span class="cnt-li-title">¿Cómo es la gestión de los partidos?</span>
                <p>Al comenzar la temporada, se generará automaticamente el calendario y podrás gestionar desde nuestra
    ...
    <div class="content-grup cnt-gr-right">
        ...
        <p class="content-text text-decoration-underline text-center">No te preocupes por las fechas, nosotros nos
            adaptamos a tus necesidades, sabemos que cada liga tiene unas necesidades por lo que haremos el calendario
    ...
    <div class="content-grup cnt-gr-left">
        ...
        <p class="content-text">Ya seas un club, una empresa o un grupo de amigos, en <span class="swap-mark">Swap Padel</span> te damos la posibilidad
    ...
    <div class="content-grup cnt-gr-left">
        ...
        <div class="content-contact d-flex justify-content-around flex-column flex-sm-row justify-content-center">
            <div class="d-flex align-items-center mb-2 mb-sm-0"><i class="fa fa-envelope-o" aria-hidden="true"></i>
                hola@swappadeltour.com</div>
            <div class="d-flex align-items-center"><i class="fa fa-instagram" aria-hidden="true"></i> @swappadel</div>
        </div>
